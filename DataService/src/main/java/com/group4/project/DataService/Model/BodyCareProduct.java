...
@Document("bodycarelist")
public class BodyCareProduct {
	...
	public String toString() {
		return "BodyCareProduct [productId=" + productId + ", productName=" + productName + ", product_Mfg_Date="
				+ product_Mfg_Date + ", product_Exp_Date=" + product_Exp_Date + ", price=" + price + "]";
	}
	public BodyCareProduct(String productId, String productName, Date product_Mfg_Date, Date product_Exp_Date,double price) {
		super();
		this.productId = productId;
		this.productName = productName;
		this.product_Mfg_Date = product_Mfg_Date;
