...
public class HairCareProduct {
	...
	public String toString() {
		return "HairCareProduct [productId=" + productId + ", productName=" + productName + ", product_Mfg_Date="
	...
	public HairCareProduct(String productId, String productName, Date product_Mfg_Date, Date product_Exp_Date,double price) {
		super();
		this.productId = productId;
		this.productName = productName;
		this.product_Mfg_Date = product_Mfg_Date;
