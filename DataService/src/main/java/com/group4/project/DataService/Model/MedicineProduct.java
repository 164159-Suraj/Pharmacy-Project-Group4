...
public class MedicineProduct {
	...
	public String toString() {
		return "MedicineProduct [productId=" + productId + ", productName=" + productName + ", product_Mfg_Date="
	...
	public MedicineProduct(String productId, String productName, Date product_Mfg_Date, Date product_Exp_Date,double price) {
		super();
		this.productId = productId;
		this.productName = productName;
		this.product_Mfg_Date = product_Mfg_Date;
